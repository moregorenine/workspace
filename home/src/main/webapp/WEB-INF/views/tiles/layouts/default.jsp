...
<link type="text/css" rel="stylesheet"
	href="<c:url value='/css/tiles/layouts/default.css'/>" />
</head>
<body>
		...
		<div id="main">
			<div class="inner">
				...
				<section>
					...
					<p>Praesent ac adipiscing ullamcorper semper ut amet ac risus.
						Lorem sapien ut odio odio nunc. Ac adipiscing nibh porttitor erat
						risus justo adipiscing adipiscing amet placerat accumsan. Vis.
						Faucibus odio magna tempus adipiscing a non. In mi primis arcu ut
						non accumsan vivamus ac blandit adipiscing adipiscing arcu metus
						...
						amet nullam veroeros adipiscing.</p>
					<div class="row">
						<div class="6u 12u$(small)">
							...
							<p>Nunc lacinia ante nunc ac lobortis. Interdum adipiscing
								...
								ut ante amet placerat aliquet. Volutpat commodo eu sed ante
								lacinia. Sapien a lorem in integer ornare praesent commodo
								adipiscing arcu in massa commodo lorem accumsan at odio massa ac
								ac. Semper adipiscing varius montes viverra nibh in adipiscing
								blandit tempus accumsan.</p>
						</div>
						<div class="6u$ 12u$(small)">
							<h3>Magna odio tempus commodo</h3>
							<p>In arcu accumsan arcu adipiscing accumsan orci ac. Felis
								id enim aliquet. Accumsan ac integer lobortis commodo ornare
					...
					<div class="row 200%">
						<div class="6u 12u$(medium)">
							...
							<div class="row">
								...
								<div class="6u$ 12u$(small)">
									...
									<ul class="icons">
										...
										<li><a href="#" class="icon fa-tumblr"><span
							...
							<div class="row">
								<div class="6u 12u$(small)">
									<ul class="actions vertical">
										<li><a href="#" class="button special">Default1</a></li>
										<li><a href="#" class="button">Default2</a></li>
									</ul>
								</div>
								<div class="6u$ 12u$(small)">
									<ul class="actions vertical small">
										<li><a href="#" class="button special small">Small3</a></li>
										<li><a href="#" class="button small">Small4</a></li>
									</ul>
								</div>
								<div class="6u 12u$(small)">
									<ul class="actions vertical">
										<li><a href="#" class="button special fit">Default5</a></li>
										<li><a href="#" class="button fit">Default6</a></li>
									</ul>
								</div>
								<div class="6u$ 12u$(small)">
									<ul class="actions vertical small">
										<li><a href="#" class="button special small fit">Small7</a></li>
										<li><a href="#" class="button small fit">Small8</a></li>
									</ul>
								</div>
							</div>
							...
							<blockquote>Lorem ipsum dolor vestibulum ante ipsum
								...
								pellentesque praesent. Lorem ipsum dolor. Lorem ipsum dolor
						...
						<div class="6u$ 12u$(medium)">
							...
							<h4>Left &amp; Right</h4>
							<p>
								<span class="image left"><img src="images/pic01.jpg"
									alt="" /></span>Lorem ipsum dolor sit accumsan interdum nisi, quis
							...
							<div class="box">
								<p>Felis sagittis eget tempus primis in faucibus vestibulum.
									Blandit adipiscing eu felis iaculis volutpat ac adipiscing
									accumsan eu faucibus. Integer ac pellentesque praesent
									tincidunt felis sagittis eget. tempus euismod. Magna sed etiam
									ante ipsum primis in faucibus vestibulum.</p>
							</div>
...
<%-- <div class="container">
		<!-- Sidebar -->
		<div id="sidebar">
			<aside class="aside" style="background-color: SteelBlue;">
				<tiles:insertAttribute name="aside" />
			</aside>
		</div>
		<!-- Main -->
		<div id="main">
			<header class="header" style="background-color: DarkKhaki;">
				<tiles:insertAttribute name="header" />
			</header>
			<nav class="nav" style="background-color: Lavender ;">
