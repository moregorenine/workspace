...
public class AbstractDispatcherServlet implements AfterRunService {
	...
	public AbstractDispatcherServlet setConfig(String config) {
		this.config = new MockServletConfig();
		this.config.addInitParameter("contextConfigLocation", "file:./src/main/webapp/WEB-INF"+config);
		return this;
	}
	
	public AbstractDispatcherServlet setLocations(String ...locations) {
		this.locations = locations;
		return this;
	}
	
	public AbstractDispatcherServlet setRelativeLocations(String ...relativeLocations) {
		this.relativeLocations = relativeLocations;
		return this;
	}
	
	public AbstractDispatcherServlet setClasses(Class<?> ...classes) {
		this.classes = classes;
		return this;
	}

	public AbstractDispatcherServlet setServletPath(String servletPath) {
	...
	public AbstractDispatcherServlet initRequest(String requestUri, String method) {
	...
	public AbstractDispatcherServlet initRequest(String requestUri, RequestMethod method) {
		return this.initRequest(requestUri, method.toString());
	}
	
	public AbstractDispatcherServlet initRequest(String requestUri) {
		this.initRequest(requestUri, RequestMethod.GET);
		return this;
	}
	
	public AbstractDispatcherServlet addParameter(String name, String value) {
		if(this.request == null) {
	...
	public AbstractDispatcherServlet buildDispatcherServlet() throws ServletException {
	...
	@Override
	public String getContentAsService() throws UnsupportedEncodingException {
